...
class AppleProduct(Produs):
    def __init__(self, nume, pret, anul_producerii, culoare, produs_conectat="nimic"):
        super().__init__(nume, pret, anul_producerii)
...
class GoogleProduct(AppleProduct):
    def __init__(self, nume, pret, anul_producerii, culoare, produs_conectat=None):
        super().__init__(nume, pret, anul_producerii, culoare, produs_conectat)

...
class UtilizatorAdmin(UtilizatorManager):
    def __init__(self, nume):
        super().__init__(nume)
...
class user:
    ...
    @nivel_acces.setter
    def nivel_acces(self, nivel_acces):
...
class Sistem:
    ...
    def adauga_utilizator(self, utilizator):
        utilizator_id = self.__next_id
        self.__utilizatori[utilizator_id] = utilizator
        self.__next_id += 1
    ...
    def modifica_name_user(self, utilizator_id, nou_nume):
        if utilizator_id in self.__utilizatori:
            self.__utilizatori[utilizator_id].nume = nou_nume
            return True
        return False

    def sterge_utilizator(self, utilizator_id):
        if utilizator_id in self.__utilizatori:
            del self.__utilizatori[utilizator_id]
            return True
        return False

    def modifica_nivel_acces(self, utilizator_id, nou_nivel_acces):
        if utilizator_id in self.__utilizatori:
            self.__utilizatori[utilizator_id].nivel_acces = nou_nivel_acces
            return True
        return False
...
class TechSolutionsApp:
    ...
    def __init__(self,versiune_applicatie):
        self.versiune_applicatie = versiune_applicatie
    @staticmethod
    def market_view():

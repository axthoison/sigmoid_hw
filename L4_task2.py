...
# CODUL TĂU VINE MAI JOS:
text = '''Ce-ti doresc eu tie, dulce Romanie \nFiind baiet paduri cutreieram
Somnoroase pasarele... \nCriticilor mei\nAtat de frageda...'''
print(text)
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
f_string = f'My name is {name} and my friend\'s name is {name2}'
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
format_string = 'My name is {} and my friend\'s name is {}'.format(name,name2)
print(format_string)
# CODUL TĂU VINE MAI SUS:

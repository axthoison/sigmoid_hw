# Aceasta este a doua ta sarcină legată de seturi #unordered_map/set c++

# Creați un set gol numit `numbers_set`

# CODUL TĂU VINE MAI JOS:
numbers_set = {1}  #if empty- TypeError: cannot convert dictionary update sequence element #0 to a sequence
